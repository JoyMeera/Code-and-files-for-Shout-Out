...
<!----SHOWCASE---->
    ...
    <div class="showcase-text">
        <p>Transportation</p>
            <div id="dynamicIcon" class="child">
                <img id ="surveyIcon" src="img/bus.png" alt="logo" class="picture">       
            </div>
    </div>
    </section>
    ...
    <section>
<!--FORM STARTS-->
<form id="my-form" action="location.php" method="post">
        ...
        <!--Emojis-->
            ...
            <br>
<!--Next Page-->
            <input type="submit" name="submit" value="Next Page" class = "btn4" onclick="validateForm()">
            </div>
        </form>
