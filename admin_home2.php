...
<html>
	...
	<body class="loggedin">
		...
		<div class="content" style="text-align: center;">
			<h2>Here are your results, <?=$_SESSION['name']?>!</h2>
		</div>
...
<head>
	...
	table {
		...
		.second-table {
			display: flex; flex-wrap: wrap;justify-content: left;align-items: center;
		}
...
$query_select = "SELECT * FROM feedback WHERE Category = '$Sort' ORDER BY ShoutOutID DESC LIMIT 20";
$query_result = mysqli_query($connection1,$query_select);
