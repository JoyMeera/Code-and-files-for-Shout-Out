    ...
    <section class="showcase">
        ...
        <p>IT</p>
            <div id="dynamicIcon" class="child" >
                <img id="surveyIcon" src="img/IT.png" alt="logo" class="picture">  
            </div>
        </div> 
    </section>
...
<form id="myForm" action="location.php" method="post">
        ...
        <!--Emojis-->
            ...
            <br>
<!--Next Page-->
            <a href="location.php"><input type="submit" name="submit" value="Next Page" class="btn4" onclick="return validateForm()"></a>
            </div>
        </form>
